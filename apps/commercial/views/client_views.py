...
from apps.commercial.forms.client_forms import ClientForm, ClientLookupForm, BranchForm
...
def client_branch_edit(request, id):
    ...
    return render(request, 'commercial/client/branch/branch_edit.html', {'form':form, 'branch':branch, 'client':client})
